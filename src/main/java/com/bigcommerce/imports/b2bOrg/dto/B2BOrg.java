package com.bigcommerce.imports.b2bOrg.dto;

public class B2BOrg {
	
	private Integer customer_number;
	private String status_1;
	private String customer_attention;
	...
	public String getCustomer_attention() {
		return customer_attention;
	}

	public void setCustomer_attention(String customer_attention) {
		this.customer_attention = customer_attention;
	}
