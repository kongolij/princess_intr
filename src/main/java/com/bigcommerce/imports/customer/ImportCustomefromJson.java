...
//@Component
public class ImportCustomefromJson implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		JsonNode resultsNode = root.path("user");
		if (!resultsNode.isArray()) {
			System.err.println("❌ Expected 'user' to be an array, but found: " + resultsNode.getNodeType());
			System.exit(1);
		}
		...
		System.out.println("\n✅ Total organization entries processed: " + count);
