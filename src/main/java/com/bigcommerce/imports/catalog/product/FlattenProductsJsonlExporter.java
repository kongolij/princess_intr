...
public class FlattenProductsJsonlExporter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream("Sample For EPAM - merged products_23.json");
        if (inputStream == null) {
        ...
        File outputFile = new File("src/main/resources/Flattened_Products_V6.jsonl");
